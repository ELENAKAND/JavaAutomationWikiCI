...
public class MWSearchPageObject extends SearchPageObject {
    static {
        ...
        SEARCH_RESULT_BY_SUBSTRING_TPL2 = "xpath://form[@class='search-box']/input[@placeholder='{SUBSTRING}']";//"xpath://h3[contains(text(),'{SUBSTRING}')]/../../a[contains(@class,'mw-ui-icon-wikimedia-unStar-progressive')]";
        ...
        SEARCH_EMPTY_RESULT_ELEMENT = "css:p.without-results";//"css:p.mw-search-nonefound";
        CLEAR_TEXT = "css:button.clear";
    }
